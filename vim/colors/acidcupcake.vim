...
" To use: place this file in ~/.vim/colors/ and add the line 'colorscheme acidcupcake' to your ~/.vimrc
" Then, if you're using Konsole, change your environment variable to be 'TERM=xterm-256color"
...
let Assignment['NonText'] = {"FG" : Colour['GREEN']}
